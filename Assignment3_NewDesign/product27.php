						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> Strapless, drop-waist, tulle gown with mermaid silhouette, sweetheart neckline, all-over pleated bodice, sweep train and lace-up back. Embellished with beads, sequins, and rhinestones. Available in Sunset and Turquoise.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Available in sunset & turquoise as shown only.</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-16</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Prom Dress/dress_3.jpg" width="280px" height="400px" border="0"/>
								<p>Click to Zoom-In</p>
							</td>
						</tr>
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product3" action="productFunction.php" method="post">
									...
									<input id="addCartBtn" name="product3" type="submit" value="Add Cart">
								</form>
							</td>
						</tr>
					</table>
