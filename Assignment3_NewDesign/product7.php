						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Taffeta, sleeveless sweetheart sheath informal bridal gown. Dress features ruching bodice detail, button up back, and short sleeve bolero included.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Informal Dress/dress_1.jpg" width="280px" height="400px" border="0"/>
