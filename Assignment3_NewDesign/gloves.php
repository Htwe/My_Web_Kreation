					...
					<table class="product_lists">
						<tr>
							<td style="height: 450px; text-align:center;">							
								<p>
									<a class="image_text" href="product67.php" title="Price = S$58">
									<img src="image/Accessories/Gloves/glove_1.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>								
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product68.php" title="Price = S$65">
									<img src="image/Accessories/Gloves/glove_2.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product69.php" title="Price = S$45">
									<img src="image/Accessories/Gloves/glove_3.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
						</tr>
						<tr>
							<td class="product_details">
								<form id="product" name="product" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0067">	
									<input type="hidden" name="ProPrice" value="58">
									<input type="hidden" name="ProDesc" value="Bridal Rhinestone Gloves, Formal Lace Gloves">
									<input type="hidden" name="ProImageName" value="glove_1.jpg">
									<input type="hidden" name="quantity" value="1">
																		
									<input type="button" id="detailsBtn" name="product" onclick="submitForm('1', 'product67.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product2" name="product2" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0068">	
									<input type="hidden" name="ProPrice" value="65">
									<input type="hidden" name="ProDesc" value="Bridal Gloves, Long Traditional Wedding Gloves">
									<input type="hidden" name="ProImageName" value="glove_2.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product2" onclick="submitForm('2', 'product68.php')" value="Details" />
							...
							<td class="product_details">
								<form id="product3" name="product3" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0069">	
									<input type="hidden" name="ProPrice" value="45">
									<input type="hidden" name="ProDesc" value="Ivory Lace Bridal gloves">
									<input type="hidden" name="ProImageName" value="glove_3.jpg">
									<input type="hidden" name="quantity" value="1">
									
									<input type="button" id="detailsBtn" name="product3" onclick="submitForm('3', 'product69.php')" value="Details" />
                        ...
                        <tr>
							<td style="height: 450px; text-align:center;">							
								<p>
									<a class="image_text" href="product70.php" title="Price = S$45">
									<img src="image/Accessories/Gloves/glove_4.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>								
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product71.php" title="Price = S$88">
									<img src="image/Accessories/Gloves/glove_5.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product72.php" title="Price = S$43">
									<img src="image/Accessories/Gloves/glove_6.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
						</tr>
						<tr>
							<td class="product_details">
								<form  id="product4" name="product4" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0070">	
									<input type="hidden" name="ProPrice" value="45">
									<input type="hidden" name="ProDesc" value="Bridal Victorian lace cuffs bridal cuffs wedding gloves">
									<input type="hidden" name="ProImageName" value="glove_4.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product4" onclick="submitForm('4', 'product70.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product5" name="product5" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0071">	
									<input type="hidden" name="ProPrice" value="88">
									<input type="hidden" name="ProDesc" value="Wedding Gloves, Ivory Ribbon Gloves">
									<input type="hidden" name="ProImageName" value="glove_5.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product5" onclick="submitForm('5', 'product71.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product6" name="product6" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0072">	
									<input type="hidden" name="ProPrice" value="43">
									<input type="hidden" name="ProDesc" value="Bridal Gloves Lace Gloves">
									<input type="hidden" name="ProImageName" value="glove_6.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product6" onclick="submitForm('6', 'product72.php')" value="Details" />
