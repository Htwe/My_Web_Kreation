...
<div class="main">
	...
	<div class="content">
		<div class="content_resize">
			...
			<div class="main_text">
				<h1>Bridesmaid Dress</h1>
				<div class="product_catalog">
					<table class="product_lists">
						<tr>
							<td style="height: 450px; text-align:center;">							
								<p>
									<a class="image_text" href="product13.php" title="Price = S$260">
									<img src="image/wedding dress/Bridesmaid Dress/dress_1.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>								
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product14.php" title="Price = S$260">
									<img src="image/wedding dress/Bridesmaid Dress/dress_2.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product15.php" title="Price = S$260">
									<img src="image/wedding dress/Bridesmaid Dress/dress_3.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
						</tr>
						<tr>
							<td class="product_details">
								<form id="product" name="product" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0013">	
									<input type="hidden" name="ProPrice" value="260">
									<input type="hidden" name="ProDesc" value="Taffeta, strapless sheath bridesmaid gown. Pleated bodice detail to asymmetrical waist with rose/flower detail.">
									<input type="hidden" name="ProImageName" value="dress_13.jpg">
									<input type="hidden" name="quantity" value="1">
																		
									<input type="button" id="detailsBtn" name="product" onClick="submitForm('1', 'product13.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product2" name="product2" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0014">	
									<input type="hidden" name="ProPrice" value="260">
									<input type="hidden" name="ProDesc" value="Chiffon, V-neck short A-line bridesmaid gown. Dress stops above the knee and has ruching wrapped bodice and strap detail.">
									<input type="hidden" name="ProImageName" value="dress_14.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product2" onClick="submitForm('2', 'product14.php')" value="Details" />
							...
							<td class="product_details">
								<form id="product3" name="product3" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0015">	
									<input type="hidden" name="ProPrice" value="260">
									<input type="hidden" name="ProDesc" value="Satin, sleeveless sweetheart sheath bridesmaid gown. Wrapped pleated bodice detail with beaded accent at waist. Jacket included.">
									<input type="hidden" name="ProImageName" value="dress_15.jpg">
									<input type="hidden" name="quantity" value="1">
									
									<input type="button" id="detailsBtn" name="product3" onClick="submitForm('3', 'product15.php')" value="Details" />
                        ...
                        <tr>
							<td style="height: 450px; text-align:center;">							
								<p>
									<a class="image_text" href="product16.php" title="Price = S$260">
									<img src="image/wedding dress/Bridesmaid Dress/dress_4.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>								
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product17.php" title="Price = S$297">
									<img src="image/wedding dress/Bridesmaid Dress/dress_5.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product18.php" title="Price = S$297">
									<img src="image/wedding dress/Bridesmaid Dress/dress_6.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
						</tr>
						<tr>
							<td class="product_details">
								<form  id="product4" name="product4" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0016">	
									<input type="hidden" name="ProPrice" value="260">
									<input type="hidden" name="ProDesc" value="Chiffon, one-shoulder short A-line bridesmaid gown. Ruched detail to pleated waist, accented with beaded embellishement.">
									<input type="hidden" name="ProImageName" value="dress_4.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product4" onClick="submitForm('4', 'product16.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product5" name="product5" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0017">	
									<input type="hidden" name="ProPrice" value="297">
									<input type="hidden" name="ProDesc" value="Strapless, satin sheath with knee-length, tulip skirt, sweetheart neckline, pleated bodice, bow detail at waist with beads and sequins, lace-up back and bolero.">
									<input type="hidden" name="ProImageName" value="dress_17.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product5" onClick="submitForm('5', 'product17.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product6" name="product6" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0018">	
									<input type="hidden" name="ProPrice" value="297">
									<input type="hidden" name="ProDesc" value="Bohemian Bridal Halo, Boho Bridal Headpiece">
									<input type="hidden" name="ProImageName" value="dress_18.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product6" onClick="submitForm('6', 'product18.php')" value="Details" />
