						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Taffeta, strapless sheath bridesmaid gown. Pleated bodice detail to asymmetrical waist with rose/flower detail.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Available in 46 colours</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Bridesmaid Dress/dress_1.jpg" width="280px" height="400px" border="0"/>
