						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Satin, strapless mermaid informal bridal gown with lace-up back, embellished with beads at empire waistline.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Ivory / Multi or White</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Informal Dress/dress_2.jpg" width="280px" height="400px" border="0"/>
