					...
					<table class="product_lists">
						<tr>
							<td style="height: 450px; text-align:center;">							
								<p>
									<a class="image_text" href="product61.php" title="Price = S$560">
									<img src="image/Accessories/Jewellery/jewellery_1.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>								
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product62.php" title="Price = S$670">
									<img src="image/Accessories/Jewellery/jewellery_2.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product63.php" title="Price = S$780">
									<img src="image/Accessories/Jewellery/jewellery_3.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
						</tr>
						<tr>
							<td class="product_details">
								<form id="product" name="product" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0061">	
									<input type="hidden" name="ProPrice" value="560">
									<input type="hidden" name="ProDesc" value="Lovely Ribbon with Perl jewellery set">
									<input type="hidden" name="ProImageName" value="jewellery_1.jpg">
									<input type="hidden" name="quantity" value="1">
																		
									<input type="button" id="detailsBtn" name="product" onclick="submitForm('1', 'product61.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product2" name="product2" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0062">	
									<input type="hidden" name="ProPrice" value="670">
									<input type="hidden" name="ProDesc" value="Crystal Shinny Flower Pattern Jewellery Set">
									<input type="hidden" name="ProImageName" value="jewellery_2.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product2" onclick="submitForm('2', 'product62.php')" value="Details" />
							...
							<td class="product_details">
								<form id="product3" name="product3" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0063">	
									<input type="hidden" name="ProPrice" value="780">
									<input type="hidden" name="ProDesc" value="While Flower Jewellery Set">
									<input type="hidden" name="ProImageName" value="jewellery_3.jpg">
									<input type="hidden" name="quantity" value="1">
									
									<input type="button" id="detailsBtn" name="product3" onclick="submitForm('3', 'product63.php')" value="Details" />
                        ...
                        <tr>
							<td style="height: 450px; text-align:center;">							
								<p>
									<a class="image_text" href="product64.php" title="Price = S$880">
									<img src="image/Accessories/Jewellery/jewellery_4.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>								
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product65.php" title="Price = S$980">
									<img src="image/Accessories/Jewellery/jewellery_5.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product66.php" title="Price = S$600">
									<img src="image/Accessories/Jewellery/jewellery_6.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
						</tr>
						<tr>
							<td class="product_details">
								<form  id="product4" name="product4" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0064">	
									<input type="hidden" name="ProPrice" value="880">
									<input type="hidden" name="ProDesc" value="Ivory Pearl Jewellery Set">
									<input type="hidden" name="ProImageName" value="jewellery_4.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product4" onclick="submitForm('4', 'product64.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product5" name="product5" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0065">	
									<input type="hidden" name="ProPrice" value="980">
									<input type="hidden" name="ProDesc" value="White Diamond Jewellery Set">
									<input type="hidden" name="ProImageName" value="jewellery_5.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product5" onclick="submitForm('5', 'product65.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product6" name="product6" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0066">	
									<input type="hidden" name="ProPrice" value="600">
									<input type="hidden" name="ProDesc" value="Crystal White Rhinestone Jewellery Set">
									<input type="hidden" name="ProImageName" value="jewellery_6.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product6" onclick="submitForm('6', 'product66.php')" value="Details" />
