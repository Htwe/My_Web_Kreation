						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> Organza strapless quinceanera ball gown with lace-up back, embroidery embellished with beaded bodice detail, pleated waistline and two toned tiered skirt. Short sleeve bolero included.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Raspberry/Multi, Magenta/Multi, or Purple/Multi</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Quinceanera Dresses/dress_1.jpg" width="280px" height="400px" border="0"/>
