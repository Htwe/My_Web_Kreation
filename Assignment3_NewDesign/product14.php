						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> Chiffon, sleeveless sweetheart sheath bridesmaid gown. Wrapped pleated bodice detail with beaded accent at waist. Jacket included.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Available in 19 colours</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Bridesmaid Dress/dress_2.jpg" width="280px" height="400px" border="0"/>
