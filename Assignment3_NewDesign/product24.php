						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> Sparkling tulle, strapless sweetheart Quinceanera ball gown with lace-up back, embroidery embellished with bead bodice and waist detail, and tulip pannier skirt. Matching short sleeve illusion bolero included.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td> Hot Pink/Multi, Sapphire/Multi, Magenta/Multi, or White/Multi</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Quinceanera Dresses/dress_6.jpg" width="280px" height="400px" border="0"/>
						...
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product6" action="productFunction.php" method="post">
									...
									<input type="hidden" name="ProDesc" value="Sparkling tulle, strapless sweetheart Quinceanera ball gown with lace-up back, embroidery embellished with bead bodice and waist detail, and tulip pannier skirt. Matching short sleeve illusion bolero included.">
