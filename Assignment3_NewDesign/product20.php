						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> A strapless Quinceanera ball gown made of iridescent satin and organza. It has a sweetheart neckline, a corset bodice with beads and embroidery, a ruffled skirt with an embroidered panel to the left, and a lace-up back. Bolero included.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Hot Magenta/Multi or Pink Rose/Multi</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
									...
									<tr class="alt">
										<td>Fabric</td>
										<td>Iridescent Satin/Organza</td>
									</tr>
									<tr>
										<td>Build-In Bra</td>
										<td>yes</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Quinceanera Dresses/dress_2.jpg" width="280px" height="400px" border="0"/>
