						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>The Lovina will be your new heartthrob. This Michael Antonio pump showcases a chic and classic shape with a red patent upper. A simple adjustable ankle strap, 4 3/4 inch heel and 3/4 inch platform completes this party look.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
									...
									<tr class="alt">
										<td>Brand</td>
										<td>Lovina PTN - Red Patent Michael Antonio</td>
									</tr>
									<tr>
										<td>Inches</td>
										<td>4 3/4</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/evening shoes/shoe_3.jpg" width="280px" height="280px" border="0"/>
