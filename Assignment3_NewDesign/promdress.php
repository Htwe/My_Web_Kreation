					...
					<table class="product_lists">
						<tr>
							<td style="height: 450px; text-align:center;">							
								<p>
									<a class="image_text" href="product25.php" title="Price = S$560">
									<img src="image/wedding dress/Prom Dress/dress_1.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>								
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product26.php" title="Price = S$560">
									<img src="image/wedding dress/Prom Dress/dress_2.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product27.php" title="Price = S$560">
									<img src="image/wedding dress/Prom Dress/dress_3.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
						</tr>
						<tr>
							<td class="product_details">
								<form id="product" name="product" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0025">	
									<input type="hidden" name="ProPrice" value="560">
									<input type="hidden" name="ProDesc" value="A strapless sheath prom dress with high side slit and beaded detail from bodice to side slit.">
									<input type="hidden" name="ProImageName" value="dress_25.jpg">
									<input type="hidden" name="quantity" value="1">
																		
									<input type="button" id="detailsBtn" name="product" onClick="submitForm('1', 'product25.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product2" name="product2" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0026">	
									<input type="hidden" name="ProPrice" value="560">
									<input type="hidden" name="ProDesc" value="Strapless, drop-waist sequin mermaid gown with tulle skirt. Detachable spaghetti straps included. Available in gold, white, and black.">
									<input type="hidden" name="ProImageName" value="dress_26.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product2" onClick="submitForm('2', 'product26.php')" value="Details" />
							...
							<td class="product_details">
								<form id="product3" name="product3" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0027">	
									<input type="hidden" name="ProPrice" value="560">
									<input type="hidden" name="ProDesc" value="Strapless, drop-waist, tulle gown with mermaid silhouette, sweetheart neckline, all-over pleated bodice, sweep train and lace-up back. Embellished with beads, sequins, and rhinestones. Available in Sunset and Turquoise.">
									<input type="hidden" name="ProImageName" value="dress_27.jpg">
									<input type="hidden" name="quantity" value="1">
									
									<input type="button" id="detailsBtn" name="product3" onClick="submitForm('3', 'product27.php')" value="Details" />
                        ...
                        <tr>
							<td style="height: 450px; text-align:center;">							
								<p>
									<a class="image_text" href="product28.php" title="Price = S$560">
									<img src="image/wedding dress/Prom Dress/dress_4.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>								
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product29.php" title="Price = S$670">
									<img src="image/wedding dress/Prom Dress/dress_5.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product30.php" title="Price = S$522">
									<img src="image/wedding dress/Prom Dress/dress_6.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
						</tr>
						<tr>
							<td class="product_details">
								<form  id="product4" name="product4" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0028">	
									<input type="hidden" name="ProPrice" value="560">
									<input type="hidden" name="ProDesc" value="Chiffon gown with sweep train over one-shoulder sheath with sweetheart neckline. Features beads, sequins, and rhinestones. Available in Royal, Azalea, and Purple. ">
									<input type="hidden" name="ProImageName" value="dress_28.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product4" onClick="submitForm('4', 'product28.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product5" name="product5" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0029">	
									<input type="hidden" name="ProPrice" value="670">
									<input type="hidden" name="ProDesc" value="A chiffon sleeveless sweetheart A-line prom dress with beads and sequin bodice detail and lace-up back.">
									<input type="hidden" name="ProImageName" value="dress_29.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product5" onClick="submitForm('5', 'product29.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product6" name="product6" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0030">	
									<input type="hidden" name="ProPrice" value="522">
									<input type="hidden" name="ProDesc" value="A sequin sleeveless sweetheart sheath prom dress with a high slit. Embellished with asymmetrical beaded detail and a multi keyhole back.">
									<input type="hidden" name="ProImageName" value="dress_30.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product6" onClick="submitForm('6', 'product30.php')" value="Details" />
