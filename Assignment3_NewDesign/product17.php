						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> Strapless, satin sheath with knee-length, tulip skirt, sweetheart neckline, pleated bodice, bow detail at waist with beads and sequins, lace-up back and bolero.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Bridesmaid Dress/dress_5.jpg" width="280px" height="400px" border="0"/>
