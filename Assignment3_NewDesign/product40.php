						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Ooh la la! Love is in the air with the Romantique by Taylor Says. This Parisian inspired pump features a slingback strap with soft suede knot. A striped satin upper covers the silhouette, pointed toe and 4 1/2 inch heel. Last but not least is a stunning Eiffel Tower design with gorgeous floral bottom.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td> Lipstick Red or Mali Blue</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-16</td>
									...
									<tr class="alt">
										<td>Brand</td>
										<td>Romantique - Magenta Taylor Says</td>
									</tr>
									<tr>
										<td>Inches</td>
										<td>4 1/2</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/day shoes/shoe_4.jpg" width="280px" height="280px" border="0"/>
						...
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product4" action="productFunction.php" method="post">
									...
									<input type="hidden" name="ProCode" value="P0040">	
									...
									<input type="hidden" name="ProImageName" value="shoe_10.jpg">
									</h4>
