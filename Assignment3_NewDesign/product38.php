						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Get super sexy height in the Supra. This Shoe Republic pump features a pink micro suede upper with adjustable mary jane strap and gold detailed 2 inch platform. A rounded toe and 5 1/2 inch stiletto heel creates a confident look.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Ivory, Blue, Black or Red</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-16</td>
									...
									<tr class="alt">
										<td>Brand</td>
										<td>Anabel Sue - Green PU Michael Antonio</td>
									</tr>
									<tr>
										<td>Inches</td>
										<td>4 1/2</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/day shoes/shoe_2.jpg" width="280px" height="280px" border="0"/>
