						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> A strapless Quinceanera ball gown made of organza with sweetheart neckline, stripes and beads on bodice, and two-toned ruffled skirt. Bolero included.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Neon Pink/Multi, Dahlia/Multi, or Turquoise/Multi</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Quinceanera Dresses/dress_3.jpg" width="280px" height="400px" border="0"/>
