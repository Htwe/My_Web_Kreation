						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Chiffon and crystal sleeveless sweetheart A-line informal bridal gown. Dress features ruching bodice detail and single pannier skirt detail. Long fitted sleeve jacket included.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Ivory / Multi, White/Multi</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Informal Dress/dress_6.jpg" width="280px" height="400px" border="0"/>
