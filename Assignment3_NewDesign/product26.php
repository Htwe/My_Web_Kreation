						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> Strapless, drop-waist sequin mermaid gown with tulle skirt. Detachable spaghetti straps included. Available in gold, white, and black.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Available in gold, white & black as shown only.</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-22</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Prom Dress/dress_2.jpg" width="280px" height="400px" border="0"/>
