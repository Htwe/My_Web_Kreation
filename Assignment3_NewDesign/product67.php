						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Bridal Rhinestone Gloves, Formal Lace Gloves</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>White</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/Accessories/Gloves/glove_1.jpg" width="280px" height="400px" border="0"/>
