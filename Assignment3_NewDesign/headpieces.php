					...
					<table class="product_lists">
						<tr>
							<td style="height: 450px; text-align:center;">							
								<p>
									<a class="image_text" href="product55.php" title="Price = S$50">
									<img src="image/Accessories/Headpieces/headpiece_1.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>								
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product56.php" title="Price = S$110">
									<img src="image/Accessories/Headpieces/headpiece_2.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product57.php" title="Price = S$75">
									<img src="image/Accessories/Headpieces/headpiece_3.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
						</tr>
						<tr>
							<td class="product_details">
								<form id="product" name="product" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0055">	
									<input type="hidden" name="ProPrice" value="50">
									<input type="hidden" name="ProDesc" value="Pearl Flower Bridal Comb, Bridal hair comb, Wedding Hair Accessories">
									<input type="hidden" name="ProImageName" value="headpiece_1.jpg">
									<input type="hidden" name="quantity" value="1">
																		
									<input type="button" id="detailsBtn" name="product" onclick="submitForm('1', 'product55.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product2" name="product2" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0056">	
									<input type="hidden" name="ProPrice" value="110">
									<input type="hidden" name="ProDesc" value="Vintage Style Bridal Hair Comb, Crystal Wedding Hair Comb">
									<input type="hidden" name="ProImageName" value="headpiece_2.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product2" onclick="submitForm('2', 'product56.php')" value="Details" />
							...
							<td class="product_details">
								<form id="product3" name="product3" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0057">	
									<input type="hidden" name="ProPrice" value="75">
									<input type="hidden" name="ProDesc" value="Rhinestone Crystal Headband, Bridal Headpiece">
									<input type="hidden" name="ProImageName" value="headpiece_3.jpg">
									<input type="hidden" name="quantity" value="1">
									
									<input type="button" id="detailsBtn" name="product3" onclick="submitForm('3', 'product57.php')" value="Details" />
                        ...
                        <tr>
							<td style="height: 450px; text-align:center;">							
								<p>
									<a class="image_text" href="product58.php" title="Price = S$176">
									<img src="image/Accessories/Headpieces/headpiece_4.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>								
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product59.php" title="Price = S$76">
									<img src="image/Accessories/Headpieces/headpiece_5.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
							<td style="height: 450px; text-align:center;">
								<p>
									<a class="image_text" href="product60.php" title="Price = S$235">
									<img src="image/Accessories/Headpieces/headpiece_6.jpg" width="280px" height="400px" border="3"/>
									</a>
								</p>
							</td>
						</tr>
						<tr>
							<td class="product_details">
								<form  id="product4" name="product4" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0058">	
									<input type="hidden" name="ProPrice" value="176">
									<input type="hidden" name="ProDesc" value="Traditional Flower Headpiece, Wedding Headpiece">
									<input type="hidden" name="ProImageName" value="headpiece_4.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product4" onclick="submitForm('4', 'product58.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product5" name="product5" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0059">	
									<input type="hidden" name="ProPrice" value="76">
									<input type="hidden" name="ProDesc" value="Wedding Headband, Porcelain Flowers">
									<input type="hidden" name="ProImageName" value="headpiece_5.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product5" onclick="submitForm('5', 'product59.php')" value="Details" />
							...
							<td class="product_details">
								<form  id="product6" name="product6" action="productFunction.php" method="post">
									<input type="hidden" name="ProCode" value="P0060">	
									<input type="hidden" name="ProPrice" value="235">
									<input type="hidden" name="ProDesc" value="Bohemian Bridal Halo, Boho Bridal Headpiece">
									<input type="hidden" name="ProImageName" value="headpiece_6.jpg">
									<input type="hidden" name="quantity" value="1">
								
									<input type="button" id="detailsBtn" name="product6" onclick="submitForm('6', 'product60.php')" value="Details" />
