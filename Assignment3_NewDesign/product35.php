						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Show off in the Syliva by Qupid. This tall sandal features triple buckles swerving into the single strap vamp. A zipper on the back, 6 1/2 inch heel and 1 1/2 inch platform perfect this sexy stiletto.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
									...
									<tr class="alt">
										<td>Brand</td>
										<td>Sylvia - Black Emboss Qupid</td>
									</tr>
									<tr>
										<td>Inches</td>
										<td>6 1/2</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/evening shoes/shoe_5.jpg" width="280px" height="280px" border="0"/>
						...
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product5" action="productFunction.php" method="post">
									...
									<input type="hidden" name="ProImageName" value="shoe_5.jpg">
									</h4>
