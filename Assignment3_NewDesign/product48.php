						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> This stylish and embellished bridal shoe by Dyeables is Rosa. The elegant peep toe pump style is sure to compliment nearly any wedding gown. Even better, the platform adds the perfect height while maintaining stabilty. Rosa is available in dyeable white satin or ivory satin. This bridal shoe looks fantastic in a variety of colors and can be customized before or after your wedding! If you are interested in additional cushioning for the big day, we suggest Tip Toes or Heavenly Heelz by Foot Petals. Sizes available range from 5-11. If you love this style but would like a higher heel, check out the Ida by Dyeables!</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>White or Ivory</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>5-11</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/shoes/bridal shoes/shoe_6.jpg" width="280px" height="400px" border="0"/>
								<p>Click to Zoom-In</p>
							</td>
						</tr>
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product6" action="productFunction.php" method="post">
									...
									<input id="addCartBtn" name="product6" type="submit" value="Add Cart">
								</form>
							</td>
						</tr>
					</table>
