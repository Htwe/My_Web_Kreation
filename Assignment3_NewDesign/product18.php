						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>A-line, chiffon gown with sweetheart neckline, spaghetti staps, empire wasitline, pleated bust , lace-up back and bolero.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Bridesmaid Dress/dress_6.jpg" width="280px" height="400px" border="0"/>
						...
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product6" action="productFunction.php" method="post">
									...
									<input type="hidden" name="ProDesc" value="A-line, chiffon gown with sweetheart neckline, spaghetti staps, empire wasitline, pleated bust , lace-up back and bolero.">
