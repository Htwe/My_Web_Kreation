						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Chantilly lace, sleeveless sweetheart sheath informal wedding bridal gown with sweep train, shirring bodice detail to ruching waistline.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Ivory or White</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Informal Dress/dress_3.jpg" width="280px" height="400px" border="0"/>
								<p>Click to Zoom-In</p>
							</td>
						</tr>
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product9" action="productFunction.php" method="post">
									...
									<input id="addCartBtn" name="product9" type="submit" value="Add Cart">
								</form>
							</td>
						</tr>
					</table>
