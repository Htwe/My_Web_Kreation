						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> Lace, mermaid gown with illusion V-neck and chapel train. Embellished with beads, pearls, sequins, and re-embroidered lace. Zipper with buttons on back.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Wedding Dress/dress_4.jpg" width="280px" height="400px" border="0"/>
