						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Chiffon gown with sweep train over one-shoulder sheath with sweetheart neckline. Features beads, sequins, and rhinestones.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Available in azalea, purple & royal as shown only.</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-16</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Prom Dress/dress_4.jpg" width="280px" height="400px" border="0"/>
						...
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product4" action="productFunction.php" method="post">
									...
									<input type="hidden" name="ProDesc" value="Chiffon gown with sweep train over one-shoulder sheath with sweetheart neckline. Features beads, sequins, and rhinestones.">
