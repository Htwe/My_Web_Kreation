						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Get wild and free in the Guta by SCHUTZ. This must have summer sandal features a tall 6 inch stiletto, crossing black vamp and white leather ankle strap. Playful tribal print envelopes the bottom, heel and 1 1/2 inch platform.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Available in White/Multi, Ivory/Multi & Champagne/Multi</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>6-10</td>
...
Schutz</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/evening shoes/shoe_2.jpg" width="280px" height="280px" border="0"/>
