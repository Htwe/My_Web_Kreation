						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>A chiffon sleeveless sweetheart A-line prom dress with beads and sequin bodice detail and lace-up back.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Apricot Ice, Peach, or Cloud 9</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-22</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Prom Dress/dress_5.jpg" width="280px" height="400px" border="0"/>
						...
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product5" action="productFunction.php" method="post">
									...
									<input type="hidden" name="ProPrice" value="672">
