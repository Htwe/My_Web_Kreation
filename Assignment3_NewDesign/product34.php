						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Shine with every step and show off! The Suzette by Ellie showcases a blinged out silver rhinestone upper and leopard 2 inch platform.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
...
Ellie Shoes</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/evening shoes/shoe_4.jpg" width="280px" height="280px" border="0"/>
