						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> A strapless sheath prom dress with high side slit and beaded detail from bodice to side slit.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Black Diamond, Lipstick Red, or Regal</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-16</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Prom Dress/dress_1.jpg" width="280px" height="400px" border="0"/>
