						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Taffeta, strapless A-line informal bridal gown embellished with beads at neckline, a natural waistline belt and includes a short fitted sleeve bolero.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Ivory / Multi, White/Multi or Platinum/Multi</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Informal Dress/dress_4.jpg" width="280px" height="400px" border="0"/>
