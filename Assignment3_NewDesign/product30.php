						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>A sequin sleeveless sweetheart sheath prom dress with a high slit. Embellished with asymmetrical beaded detail and a multi keyhole back.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Prom Dress/dress_6.jpg" width="280px" height="400px" border="0"/>
