						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>ulie-A302 by Allure Bridals is the perfect peep toe wedding shoe! The beautiful lace covered bodice of the shoe will make you feel like a princess, and the adoreable bow on the heel adds a girly touch! The 4 1/4 inch heel is manageable due to the 3/4 inch platform. If you are interested in additional cushioning, we suggest you try Tip Toes or Heavenly Heelz by Foot Petals. Sizes available range from 5.5-10,11.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Ivory or Satin</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-16</td>
									...
									<tr class="alt">
										<td>Brand</td>
										<td>Julie-A320 by Allure Bridal</td>
									</tr>
									<tr>
										<td>Inches</td>
										<td>4 1/4</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/bridal shoes/shoe_2.jpg" width="280px" height="280px" border="0"/>
								<p>Click to Zoom-In</p>
							</td>
						</tr>
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product2" action="productFunction.php" method="post">
									...
									<input id="addCartBtn" name="product2" type="submit" value="Add Cart">
								</form>
							</td>
						</tr>
					</table>
