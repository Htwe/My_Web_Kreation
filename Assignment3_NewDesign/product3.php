						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Satin strapless Mermaid gown , Sweetheart neckline, with Natural waistline , Plus size and large size available, Rhinestone/Embroidery and flower accents. Lace-up back, Sweep train, Bolero</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Wedding Dress/dress_3.jpg" width="280px" height="400px" border="0"/>
