						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Trump the fashion world in the tantalizing Thiago. This trendy sandal features a see through vamp with white piping and synthetic upper. Gold hardware on the ankle strap deliver and edge while a 4 1/2 inch heel adds a boost.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td> Black or Blue</td>
...
Shoe Republic</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/evening shoes/shoe_6.jpg" width="280px" height="280px" border="0"/>
