						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> A strapless Quinceanera ball gown made of organza and sequined tulle. It has sweetheart neckline, lace-up back, chapel train, and a bodice with beads, rhinestones, and pearls. Short sleeve bolero.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Quinceanera Dresses/dress_4.jpg" width="280px" height="400px" border="0"/>
