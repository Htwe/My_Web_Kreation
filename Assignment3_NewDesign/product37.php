						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Heat up your look in this fancy floral by Guess. The Huela features a mixed print upper created with a soft leather. A slingback strap, 5 inch heel and 1 inch platform finish up this sleek sandal.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Baby Pink, Grey, Gold, Black, Ivory</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>5-12</td>
									...
									<tr class="alt">
										<td>Brand</td>
										<td>Huela - Nat Multi Leather Guess Shoes</td>
									</tr>
									<tr>
										<td>Inches</td>
										<td>5</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/day shoes/shoe_1.jpg" width="280px" height="280px" border="0"/>
