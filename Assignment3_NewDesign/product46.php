						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Percy-1-Ivory by Blossom is a beautiful choice for an ivory lace shoe. This style can be worn by so many women. Percy is great for a date night, or a bride who needs an ivory lace shoe to compliment her wedding gown. Your foot will be secure in this peep toe platform with closed pump heel. If you are interested in additional cushioning for the big day, we suggest Tip Toes or Heavenly Heelz by Foot Petals. Sizes available range from 7-11.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Ivory</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/bridal shoes/shoe_4.jpg" width="280px" height="280px" border="0"/>
								<p>Click to Zoom-In</p>
							</td>
						</tr>
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product4" action="productFunction.php" method="post">
									...
									<input id="addCartBtn" name="product4" type="submit" value="Add Cart">
								</form>
							</td>
						</tr>
					</table>
