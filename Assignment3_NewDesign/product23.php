						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td> A strapless Quinceanera ball gown made of organza and sequined tulle. It has sweetheart neckline, lace-up back, chapel train, and a bodice with beads, rhinestones, and pearls. Short sleeve bolero included.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td> White/Multi or Ivory/Multi or Platinum/Multi</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>2-30</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 450px; text-align:center; width:300px">								
								<img src="image/wedding dress/Quinceanera Dresses/dress_5.jpg" width="280px" height="400px" border="0"/>
						...
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product5" action="productFunction.php" method="post">
									...
									<input type="hidden" name="ProDesc" value="A strapless Quinceanera ball gown made of organza and sequined tulle. It has sweetheart neckline, lace-up back, chapel train, and a bodice with beads, rhinestones, and pearls. Short sleeve bolero included.">
