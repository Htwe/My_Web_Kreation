						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>This amazing peep toe pump bridal shoe by Nina is the Maybell-YS. The flower decoration at the heel truly makes this shoe unique. Not only is this shoe gorgeous, it is comfortable too, with the platform under the ball of the foot. Sizes available range from 6-10. Maybell-YS is available in ivory satin only.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td>Ivory</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/bridal shoes/shoe_3.jpg" width="280px" height="280px" border="0"/>
						...
						<tr>
							<td style="height: 60px; text-align:right;">
								<form name="product3" action="productFunction.php" method="post">
									...
									<input type="hidden" name="ProImageName" value="shoe_15.jpg">
									</h4>
