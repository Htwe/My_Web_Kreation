						...
						<tr>
							<td>
								<table id="item_details">
									<tr>
										<td>Description</td>
										<td>Earn your fashion credentials in this stunner from Jessica Simpson. Waleo brings you a tropical multi print upper and a picture perfect almond shaped toe. Espadrille on the 5 1/4 inch heel and 1 1/4 inch platform complete this fashionable pump.</td>
									</tr>
									<tr class="alt">
										<td>Colour</td>
										<td> Available in Multi Colors</td>
									</tr>
									<tr>
										<td>Size</td>
										<td>5-12</td>
									...
									<tr class="alt">
										<td>Brand</td>
										<td>Waleo - Multi Pink Miami Flr</td>
									</tr>
									<tr>
										<td>Inches</td>
										<td>5 1/4</td>
							...
							<td class="zoom" id="ex" rowspan="2" style="border:3px solid #980000; height: 280px; text-align:center; width:280px">								
								<img src="image/shoes/day shoes/shoe_6.jpg" width="280px" height="280px" border="0"/>
