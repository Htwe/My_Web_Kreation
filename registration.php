...
<title>Yes I Do | Registration</title>
...
function validForm(form){
	...
	if(!Username.test(form.Username.value)){
		alert('Username should be contain only numbers and alphabets');
		form.Username.focus();
		return false;
	}
	if(form.Pass.value == ""){
	...
	psw = /^[0-9a-zA-Z]+$/;
	if(!psw.test(form.Pass.value)){
		alert('Password should be contain only numbers and alphabets!');
		form.Username.focus();
		return false;
	}
	...
	var PhNo = /^[0-9]/;
	if(!PhNo.test(form.ContactNo.value)){
...
<?php
					...
					if (isset($_REQUEST['Register']) ){
						...
						$query = "INSERT INTO yesido_db.user(Username, FName, LName, Email, Occupation, Contact, Address, Country, Postal, Pass)
						 VALUES ('" . $_REQUEST['Username'] ."','" . $_REQUEST['FName'] ."','" . $_REQUEST['LName'] ."','" . $_REQUEST['Email'] ."','" . $_REQUEST['Occupation'] ."','" .$_REQUEST['Contact'] ."','" .$_REQUEST['Address'] ."','" .$_REQUEST['Country'] ."','" .$_REQUEST['Postal'] ."','" .$_REQUEST['Pass'] ."')";
	...
	<div class="header">
		<div class="header_resize">
			<div class="customer_connect">
				<table>
					<tr>
						<td style="width: 100px; padding-left: 300px; "><a href="https://www.facebook.com/yesidoweddingdressjcu" style="text-decoration: none;"><img src="image/Logos/facebook.png"/></a></td>
						<td style="width: 100px; text-align:center;"><a href="#" style="text-decoration: none;"><img src="image/Logos/twitter.png"/></a></td>
						<td style="width: 100px; text-align:center;"><a href="#" style="text-decoration: none;"><img src="image/Logos/google.png"/></a></td>
                        <td style="width: 200px; padding-left:400px;"><?php 
								if(isset($_SESSION['Username'])){
								echo($_SESSION['Username']."</a>&nbsp; <a href = 'logout.php' style='text-decoration: none'><img src='image/Logos/Logout.png'/></a>");
								}else {
								echo ("<a href='login.php' style='text-decoration: none;'>Login</a><a href='registration.php' style='text-decoration: none;'><img src='image/Logos/Register.png'/></a>");
								}
						?></td>
					</tr>
				</table>
		...
		<div class="content_resize">
            ...
            <br />   
				...
				<form name='registration' method="get" >
					...
					<input type="text" name="Username" size="15" required="required" pattern="^[a-zA-Z]+$" title="Please enter your username name" /> 
					</p>
					<p>
					<label for="FName"><b>*</b>First Name</label> 
					<input type="text" name="FName" size="15" required="required" pattern="^[a-zA-Z]+$" title="Please enter your first name" /> 
					</p>
					<p>
					<label for="LastName"><b>*</b>Last Name</label> 
					<input type="text" name="LName" size="15" required="required" pattern="^[a-zA-Z]+$" title="Please enter your last name" /> 
					</p>
					<p>
					...
					<input type="password" name="Pass" id="password" placeholder="Be clever" required="required" />
					</p>
					<p>
					<label for="confirm"><b>*</b>Confirm Password</label>
					<input type="password" name="CPass" id="password_confirm"  placeholder="Say it again" required="required" oninput="check(this)"/>
					</p>     
					
					<p>              
					<label for="Occupation"><b>*</b>Occupation</label>  
					<input type="text" name="Occupation" size="30"  required="required"/>
					</p>
					<p>
					<label for="ContactNumber">Contact Number</label>  
					<input type="tel" name="Contact" size="10" />
					</p>
					<p> 
